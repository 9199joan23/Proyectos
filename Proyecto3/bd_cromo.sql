...
ALTER TABLE  `tbl_usuarios` ADD `usu_estado` ENUM ('Sin confimación','Activado','No disponible') NOT NULL;
ALTER TABLE `tbl_recursos` ADD `rec_estado` ENUM ('Operativo','Reparando','Descartado') NOT NULL;